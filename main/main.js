...
const rollDie = () => {
    ...
    if(p2Turn === true){
      dieBtn.style.display='none'
      actionText.innerText = 'Player 2 rolled the die'  
      die.classList.add('spin')
      setTimeout(() => {
          die.classList.remove('spin')
          let result = Math.floor(Math.random() * 6) + 1
...
const p1Move = (num) => {
    ...
    target.appendChild(p1Icon)
        ...
        p1Cash += 250
        p1Money.innerText = `Money: $${p1Cash}`
        actionText.innerText = 'Player 1 landed on green and gained $250!'
        setTimeout(() => {
            switchTurn()
        }, 5000)
        }
        ...
        p1Cash -= 350
        p1Money.innerText = `Money: $${p1Cash}`
        actionText.innerText = 'Player 1 landed on red and lost $350!'
        setTimeout(() => {
            switchTurn()
        }, 5000)
        }
        ...
        if(p1Icon.parentElement.className.includes('yellow')){
            actionText.innerText = 'Player 1 landed on a random event space!'
            randEvent()
            setTimeout(() => {
                switchTurn()
            }, 5000)
        ...
        if(p1Icon.parentElement.className.includes('purp')){
            if(p1Icon.parentElement.id === '9'){
                ...
                if(WWowned === 1){
                    p1Cash += 350
                    p1Money.innerText = `Money: $${p1Cash}`
                    actionText.innerText = 'Player 1 collected $350 from their property'
                    setTimeout(() => {
                        switchTurn()
                    }, 3000)
                }
                if(WWowned === 2){
                    ...
                    p1Money.innerText = `Money: $${p1Cash}`
                    p2Money.innerText = `Money: $${p2Cash}`
                    actionText.innerText = 'Player 1 had to pay player 2 $200 for landing on their property!'
                    setTimeout(() => {
                        switchTurn()
                    }, 3000)
                }
...
const p2Move = (num) => {
    if(p2Position + num < 31){
        ...
        if(p2Icon.parentElement.className.includes('empty')){
            ...
            p2Cash += 250
            p2Money.innerText = `Money: $${p2Cash}`
            actionText.innerText = 'Player 2 landed on green and gained $250!'
            setTimeout(() => {
                switchTurn()
            }, 5000)
            }
            ...
            p2Cash -= 350
            p2Money.innerText = `Money: $${p2Cash}`
            actionText.innerText = 'Player 2 landed on red and lost $350!'
            setTimeout(() => {
                switchTurn()
            }, 5000)
            }
            ...
            if(p2Icon.parentElement.className.includes('yellow')){
                actionText.innerText = 'Player 2 landed on a random event space!'
                randEvent()
                setTimeout(() => {
                    switchTurn()
                }, 5000)
            ...
            if(p2Icon.parentElement.className.includes('purp')){
                if(p2Icon.parentElement.id === '9'){
                    ...
                    if(WWowned === 1){
                        ...
                        p1Money.innerText = `Money: $${p1Cash}`
                        p2Money.innerText = `Money: $${p2Cash}`
                        actionText.innerText = 'Player 2 had to pay player 1 $200 for landing on their property!'
                        setTimeout(() => {
                            switchTurn()
                        }, 3000)
                    }
                    if(WWowned === 2){
                        p2Cash += 350
                        p2Money.innerText = `Money: $${p2Cash}`
                        actionText.innerText = 'Player 2 collected $350 from their property'
                        setTimeout(() => {
                            switchTurn()
                        }, 3000)
                    }
                ...
                if(p2Icon.parentElement.id === '15'){
                    ...
                    if(SSowned === 2){
                        p2Cash += 350
                        p2Money.innerText = `Money: $${p2Cash}`
                        actionText.innerText = 'Player 2 collected $200 from their property!'
                        setTimeout(() => {
                            switchTurn()
                        }, 3000)
                    }
    ...
    .then(res => {
        ...
        if(res.data === 'G3'){
            if(p1Turn === true){
                ...
                p1Money.innerText = `Money: $${p1Cash}`
                setTimeout(() => {
                actionText.innerText = 'Player 1 gained $300'
                }, 1500)
            } else {
                p2Cash += 300
                p2Money.innerText = `Money: $${p2Cash}`
                setTimeout(() => {
                    actionText.innerText = 'Player 2 gained $300'
                    }, 1500)
            }
        }
        if(res.data === 'G1'){
            if(p1Turn === true){
                ...
                p1Money.innerText = `Money: $${p1Cash}`
                setTimeout(() => {
                    actionText.innerText = 'Player 1 gained $100'
                    }, 1500)
            } else {
                p2Cash += 100
                p2Money.innerText = `Money: $${p2Cash}`
                setTimeout(() => {
                    actionText.innerText = 'Player 2 gained $100'
                    }, 1500)
            }
        }
        if(res.data === 'S50'){
            if(p1Turn === true){
                ...
                p2Money.innerText = `Money: $${p2Cash}`
                setTimeout(() => {
                actionText.innerText = 'Player 1 stole $50 from Player 2!'
                }, 1500)
            } else {
                p2Cash += 50
                p1Cash -= 50
                ...
                p2Money.innerText = `Money: $${p2Cash}`
                setTimeout(() => {
                    actionText.innerText = 'Player 2 stole $50 from Player 1!'
                    }, 1500)
            }
        }
        if(res.data === 'S2'){
            if(p1Turn === true){
                ...
                p2Money.innerText = `Money: $${p2Cash}`
                setTimeout(() => {
                    actionText.innerText = 'Player 1 stole $200 from Player 2!'
                    }, 1500)
            } else {
                p2Cash += 200
                p1Cash -= 200
                ...
                p2Money.innerText = `Money: $${p2Cash}`
                setTimeout(() => {
                    actionText.innerText = 'Player 2 stole $200 from Player 1!'
                    }, 1500)
            }
        }
        if(res.data === 'L50'){
            ...
            p1Money.innerText = `Money: $${p1Cash}`
            setTimeout(() => {
                actionText.innerText = 'Player 1 lost $50'
                }, 1500)
            } else {
            p2Cash -= 50
            p2Money.innerText = `Money: $${p2Cash}`
            setTimeout(() => {
                actionText.innerText = 'Player 2 lost $50'
                }, 1500)
            }
        }
        if(res.data === 'L1'){
            ...
            p1Money.innerText = `Money: $${p1Cash}`
            setTimeout(() => {
                actionText.innerText = 'Player 1 lost $100'
                }, 1500)
            } else {
            p2Cash -= 100
            p2Money.innerText = `Money: $${p2Cash}`
            setTimeout(() => {
                actionText.innerText = 'Player 2 lost $100'
                }, 1500)
            }
        }
...
const buyProp = () => {
    ...
    if(p1Turn === true){
        if(p1Cash > 499){
            ...
            p1Cash -= 500
            p1Money.innerText = `Money: $${p1Cash}`
            actionText.innerText = 'Player 1 bought Wacky Walkway for $500!'
            WWowned = 1
            ...
            if(p1Icon.parentElement.id === '15'){
                p1Cash -= 500
                p1Money.innerText = `Money: $${p1Cash}`
                actionText.innerText = 'Player 1 bought Silly Street for $500!'
                SSowned = 1
            ...
            if(p1Icon.parentElement.id === '22'){
                p1Cash -= 500
                p1Money.innerText = `Money: $${p1Cash}`
                actionText.innerText = 'Player 1 bought Bouncy Boulevard for $500!'
                BBowned = 1
            ...
            if(p1Icon.parentElement.id === '27'){
                p1Cash -= 500
                p1Money.innerText = `Money: $${p1Cash}`
                actionText.innerText = 'Player 1 bought Funky Park for $500!'
                FPowned = 1
            ...
            actionText.innerText = 'You do not have enough money!'
            setTimeout(() => {
                switchTurn()
        }, 2000)
        }
    ...
    if(p2Turn === true){
        if(p2Cash > 499){
            ...
            p2Cash -= 500
            p2Money.innerText = `Money: $${p2Cash}`
            actionText.innerText = 'Player 2 bought Wacky Walkway for $500!'
            WWowned = 2
            ...
            if(p2Icon.parentElement.id === '15'){
                p2Cash -= 500
                p2Money.innerText = `Money: $${p2Cash}`
                actionText.innerText = 'Player 2 bought Silly Street for $500!'
                SSowned = 2
            ...
            if(p2Icon.parentElement.id === '22'){
                p2Cash -= 500
                p2Money.innerText = `Money: $${p2Cash}`
                actionText.innerText = 'Player 2 bought Bouncy Boulevard for $500!'
                BBowned = 2
            ...
            if(p2Icon.parentElement.id === '27'){
                p2Cash -= 500
                p2Money.innerText = `Money: $${p2Cash}`
                actionText.innerText = 'Player 2 bought Funky Park for $500!'
                FPowned = 2
...
const switchTurn = () => {
    if(p1Turn === true){
        p1Turn = false
        p2Turn = true
        turnText.innerText = 'It is player 2s turn!'
        yesBtn.style.display='none'
        noBtn.style.display='none'
        die.style.display='inline'
        dieResult.style.display='inline'
        setTimeout(() => {
            actionText.innerText = 'Roll the die player 2!'
            dieBtn.style.display='inline'
        }, 500)
        ...
        p2Turn = false
        p1Turn = true
        turnText.innerText = 'It is player 1s turn!'
        yesBtn.style.display='none'
        noBtn.style.display='none'
        dieBtn.style.display='inline'
        die.style.display='inline'
        dieResult.style.display='inline'
        setTimeout(() => {
            actionText.innerText = 'Roll the die player 1!'
        }, 500)
    }
}
